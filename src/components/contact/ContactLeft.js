...
const ContactLeft = () => {
  return (
    <motion.div
      className="w-full lgl:w-[35%] h-full font-Font bg-gradient-to-r from-[#1e2024] to-[#23272b] p-4 lgl:p-8 rounded-lg shadow-shadowOne flex flex-col gap-8 justify-center"
      initial="hidden"
      whileInView="visible"
